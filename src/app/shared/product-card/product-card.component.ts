...
export class ProductCardComponent implements OnDestroy {
  ...
  /** Формат ID для шаблона: единая утилита */
  ...
  /** Вся геометрия меню делегирована чистой функции computeMenuPosition */
  private updateMenuPosition(): void {
    ...
    const menuHeight =
      this.statusMenu()?.nativeElement.getBoundingClientRect().height ?? this.ESTIMATED_MENU_HEIGHT;
